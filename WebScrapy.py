...
class WebScrapy():
    ...
    def __init__(self):
        self.head = config3.obj.Headers()
        self.cred = config3.obj.Credentials()
        self.url1 = config3.obj.url_store()
